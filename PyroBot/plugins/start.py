...
async def start_command(bot, message):
    ...
    text = f"Hᴇʏ ᴛʜᴇʀᴇ {user.first_name} ❤️\n"\
           f"☆ Mʏsᴇʟғ 𝗤𝗨𝗜𝗭 𝗡𝗜𝗡𝗝𝗔. I ᴀᴍ ᴀɴ Mᴏᴅᴇʀɴ ɪɴᴛᴇʟʟɪɢᴇɴᴄᴇ ʙᴀsᴇᴅ 𝚀𝚄𝙸𝚉 𝙿𝙾𝙻𝙻 𝙱𝙾𝚃 ᴡʜɪᴄʜ ᴄᴀɴ ʙᴇ ᴜsᴇᴅ ᴛᴏ sᴇɴᴅ ᴛʜᴇ ǫᴜɪᴢᴢᴇs ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘꜱ ʙᴀsᴇᴅ ᴏɴ ᴘʀᴇғᴇʀᴇɴᴄᴇs !! ☆\n\n"\
    ...
    keyboard = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("❓ HELP", callback_data="help_comand")],
...
async def help_comand(bot, message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [InlineKeyboardButton("➕𝗔𝗗𝗗 𝗠𝗘 𝗜𝗡 𝗬𝗢𝗨𝗥 𝗚𝗥𝗢𝗨𝗣", switch_inline_query="")],
            [InlineKeyboardButton("📢 CHANNEL", url="https://t.me/CODERS_ZONE"),
             InlineKeyboardButton("🆘 SUPPORT", url="https://t.me/codder_chat")],
        ]
    )
